...
Date: 2015/09 (Last Modified on: 16/04)
----------------------------------------------*/
...
{
	//MyEntity Objects
	MyEntityClass* m_pBall = nullptr;
	MyEntityClass* m_pBoxT = nullptr;
	MyEntityClass* m_pBoxB = nullptr;
	MyEntityClass* m_pBoxL = nullptr;
